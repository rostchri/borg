class ApplicationController < ActionController::Base
  ...
  before_filter :require_user,           :except => [:feed,:feedlinks,:downloadlinks] # always require login to access any content at this site
  before_filter :require_http_auth_user, :only   => [:feed,:feedlinks]                # http_auth for all feeds or use ?user_credentials=<single_access_token>. only downloadlinks-url is public accessible
